...
with tabs[9]:
    ...
    with prov_col2:
        ...
        actual distance/time and cutoff/segment fields are from the <b>public Delhivery dataset</b>.
        ...
        Delhivery financials or emissions data.
        </div>
        """, unsafe_allow_html=True)
